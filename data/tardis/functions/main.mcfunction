# execute unless score PowerTimer tardis_int_prop matches 185 if score Power tardis_int_prop matches 1 run scoreboard players add PowerTimer tardis_int_prop 1
...
# execute as @e[tag=monitor] if score PowerTimer tardis_int_prop matches 1 if score Power tardis_int_prop matches 1 run playsound minecraft:tardis.int_startup_1 master @a 0 67 -12 999999
# execute as @e[tag=monitor] if score PowerTimer tardis_int_prop matches 139 if score Power tardis_int_prop matches 1 run playsound minecraft:tardis.monitor_beep master @a 0 67 -12 999999
# execute as @e[tag=monitor] if score PowerTimer tardis_int_prop matches 139 if score Power tardis_int_prop matches 1 run playsound minecraft:tardis.primer master @a 0 67 -12 999999
