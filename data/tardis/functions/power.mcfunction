...
execute in tardis:tardis if score Power tardis_int_prop matches -2 run item replace entity @e[type=item_frame,tag=monitor] container.0 with wooden_shovel{CustomModelData:222222}
